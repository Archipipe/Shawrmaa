<template>
    ...
    <div class="wrapper">
        <div class="greeting">
            <h1>Приветствуем!</h1>
            <div class="text"><h3>Войдите в акаунт, чтобы посмотреть наши шаурмы</h3></div>
        </div>
      ...
      <div class="text">
        <p>Если у вас нет аккаунта <RouterLink :to="{ name: 'signup' }"> нажмите сюда</RouterLink> чтобы зарегистрироваться</p>
      </div>
    </div>
  </UiContanier>
